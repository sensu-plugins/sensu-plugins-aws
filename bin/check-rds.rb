...
class CheckRDS < Sensu::Plugin::Check::CLI
  ...
  def memory_total_bytes(instance_class)
    memory_total_gigabytes = {
      ...
      'db.m5.16xlarge'            => 256.0,
      'db.m5.24xlarge'            => 384.0,
      'db.m5d.large'              => 8.0,
      'db.m5d.xlarge'             => 16.0,
      'db.m5d.2xlarge'            => 32.0,
      'db.m5d.4xlarge'            => 64.0,
      'db.m5d.8xlarge'            => 128.0,
      'db.m5d.12xlarge'           => 192.0,
      'db.m5d.16xlarge'           => 256.0,
      'db.m5d.24xlarge'           => 384.0,
      'db.m6g.large'              => 8.0,
      'db.m6g.xlarge'             => 16.0,
      'db.m6g.2xlarge'            => 32.0,
      'db.m6g.4xlarge'            => 64.0,
      'db.m6g.8xlarge'            => 128.0,
      'db.m6g.12xlarge'           => 192.0,
      'db.m6g.16xlarge'           => 256.0,
      'db.r3.large'               => 15.0,
      'db.r3.xlarge'              => 30.5,
      'db.r3.2xlarge'             => 61.0,
      'db.r3.4xlarge'             => 122.0,
      ...
      'db.r5.8xlarge'             => 256.0,
      'db.r5.12xlarge'            => 384.0,
      'db.r5.16xlarge'            => 512.0,
      'db.r5.24xlarge'            => 768.0,
      'db.r5.large.tpc1.mem2x'    => 32.0,
      'db.r5.xlarge.tpc2.mem2x'   => 64.0,
      'db.r5.xlarge.tpc2.mem4x'   => 128.0,
      'db.r5.2xlarge.tpc1.mem2x'  => 128.0,
      'db.r5.2xlarge.tpc2.mem4x'  => 256.0,
      'db.r5.2xlarge.tpc2.mem8x'  => 512.0,
      'db.r5.4xlarge.tpc2.mem2x'  => 256.0,
      'db.r5.4xlarge.tpc2.mem3x'  => 384.0,
      'db.r5.4xlarge.tpc2.mem4x'  => 512.0,
      'db.r5.6xlarge.tpc2.mem4x'  => 768.0,
      'db.r5.8xlarge.tpc2.mem3x'  => 768.0,
      'db.r5.12xlarge.tpc2.mem2x' => 768.0,
      'db.r5b.large'              => 16.0,
      'db.r5b.xlarge'             => 32.0,
      'db.r5b.2xlarge'            => 64.0,
      'db.r5b.4xlarge'            => 128.0,
      'db.r5b.8xlarge'            => 256.0,
      'db.r5b.12xlarge'           => 384.0,
      'db.r5b.16xlarge'           => 512.0,
      'db.r5b.24xlarge'           => 768.0,
      'db.r5d.large'              => 16.0,
      'db.r5d.xlarge'             => 32.0,
      'db.r5d.2xlarge'            => 64.0,
      'db.r5d.4xlarge'            => 128.0,
      'db.r5d.8xlarge'            => 256.0,
      'db.r5d.12xlarge'           => 384.0,
      'db.r5d.16xlarge'           => 512.0,
      'db.r5d.24xlarge'           => 768.0,
      'db.r6g.large'              => 16.0,
      'db.r6g.xlarge'             => 32.0,
      'db.r6g.2xlarge'            => 64.0,
      'db.r6g.4xlarge'            => 128.0,
      'db.r6g.8xlarge'            => 256.0,
      'db.r6g.12xlarge'           => 384.0,
      'db.r6g.16xlarge'           => 512.0,
      'db.t1.micro'               => 0.615,
      'db.t2.micro'               => 1.0,
      'db.t2.small'               => 2.0,
      'db.t2.medium'              => 4.0,

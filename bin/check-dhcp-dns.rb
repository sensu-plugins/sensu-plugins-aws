...
#
# DESCRIPTION:
#   Checks the VPCs dhcp settings to ensure nameservers are functional
#
# OUTPUT:
#   plain-text
#
...
#
# USAGE:
#   ./check-dhcp-dns.rb -v vpc-12345678
#   ./check-dhcp-dns.rb -v vpc-12345678 -r us-east-1
#   ./check-dhcp-dns.rb -v vpc-12345678 -r us-east-1 -q google.com,internal.private.servers
#
# NOTES:
#
# LICENSE:
